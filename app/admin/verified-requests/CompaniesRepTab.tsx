...
interface CompaniesRepTabProps {
  active: boolean;
}
...
interface UserWithCompanyProfileAndDocuments extends User {
  companyProfile: CompanyProfileWithCompany;
  documents: Document[];
}

const CompaniesRepSkeleton = () => {
  return (
...
const CompaniesRepTab: React.FC<CompaniesRepTabProps> = ({ active }) => {
  const [verifiedUsers, setVerifiedUsers] = useState<
    UserWithCompanyProfileAndDocuments[]
  >([]);
    ...
    const fetchVerifiedUsers = async () => {
      try {
        ...
        const response = await fetch(
          "/api/admin/verification-requests?role=COMPANY_REPRESENTATIVE&status=APPROVED"
        );
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      // Remove the deleted company representative from the list
      ...
      <Card className="border-dashed">
        <CardContent className="flex flex-col items-center justify-center py-10">
          ...
          <p className="text-muted-foreground text-center">
            No verified Company Representatives at the moment.
          </p>
        </CardContent>
      </Card>
    );
                ...
                <div className="flex justify-between space-y-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <Badge variant="outline" className="text-sm">
                      {user.companyProfile?.company.name || "N/A"}
                    </Badge>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              Company Representative and all associated data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
...
export default CompaniesRepTab;
